...
// 2: JavaScript Stores Dates as Milliseconds:
...
console.log(date7);
console.log(date8);
// NOTE-> agar hum date ko kisi bhi recognizable format me likhte hai to js use apne aap pehchaan leta hai
...
date9.setFullYear(2025);
console.log(date9); // Date object with the year set to 2025

//? setMonth(monthValue[, dayValue]): Sets the month for a specified date according to local time.
date9.setMonth(5); // June (months are zero-based)
console.log(date9); // Date object with the month set to June

//? setDate(dayValue): Sets the day of the month for a specified date according to local time.
date9.setDate(15);
console.log(date9); // Date object with the day of the month set to 15
...
console.log(date11); // Date object with the milliseconds set to 500
...
// NOTE =>  locale refers to a specific language and region format used to represent date and time. It determines how the date, time, numbers, and text are formatted based on cultural conventions.
...
const localString = date13.toLocaleString();
...
const localDateString = date14.toLocaleDateString();
...
const localTimeString = date15.toLocaleTimeString();
console.log(localTimeString); // Example output: "4:30:00 PM" (depending on the locale)

//? 5: parse(): 
// Parses a string representation of a date and returns the number of milliseconds since January 1, 1970, 00:00:00 UTC.
const dateString1 = "2024-02-19T16:30:00Z";
const parsedDate = Date.parse(dateString1);
...
console.log(newDate.getTime()); // same method as Date.now(), both gives milliseconds
...
// // Example usage:
const date16 = new Date("2024-02-29");
const newDate1 = addDaysToDate(date, 7);
...
// // Example usage:
const date17 = new Date("2024-02-19");
const date18 = new Date("2024-03-01");
console.log(getDaysDifference(date17, date18)); // Output: 11 (difference in days)
