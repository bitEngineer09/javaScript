...
// const person = { name, age }; // if both key and value are same, then use this
// console.log(person);
...
// In destructuring, properties kaa hee naam rakhna padega
const { age, name } = user; // yaha age nad name ki badle kuch or nahi variable nahi rakh sakte
