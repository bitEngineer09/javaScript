...
console.log(person[`is'Student`]); // aise bhi access kar sakte hai
...
person["job"] = "web dev"; // SQUARE BRACKET NOTATION
person.age = 18;
person["age"] = 20;
...
// differnt naam ho sakte hai, but value will be the same

// to make any key dynamic in objects, go with Square Bracket Notation
let student = {
  //idType me hum multiple ids daal sakte w.o changing the varibale, FOR eg -> adhar card, voterID, etc
...
let obj3 = {};
let newObj = Object.assign(obj3, obj2);
...
obj4.greet(); // esi object ko refer kar dega, check in console
...
const obj6 = {
  ...
  // using fat arrow function, it will now refer to the global object, not that particular object.
  greet: () => {
    console.log(this); // window object de dega
  },
};
...
console.log(product1.hasOwnProperty("isStudent")); // Output: false

// ? 5: Object.assign(): 
// Copies the values of all enumerable own properties from one or more source objects to a target object.
const target = { a: 1, b: 5 };
const source = { b: 3, c: 4 }; // source vala data override kar deta hai
...
const mergedObject1 = Object.assign({}, target1, source1);
...
const addSubjectGrade = (student1, subject, marks) => {
  if (!student1.grades) {
    student1.grades = {};
  }
